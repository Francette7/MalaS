...
rails_ujs__WEBPACK_IMPORTED_MODULE_1___default.a.start(); // Uncomment to copy all static images under ../images to the output folder and reference
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('turbolinks:load', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.envoi').off("click").on("click", function () {
    var id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('id');
    rails_ujs__WEBPACK_IMPORTED_MODULE_1___default.a.ajax({
...
/******/ });
//# sourceMappingURL=application-8bc5a1e33393db8d9367.js.map